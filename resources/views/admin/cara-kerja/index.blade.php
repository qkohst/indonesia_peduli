                                ...
                                <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form class="form-horizontal form-label-left" action="{{ route('set-carakerja.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="form-group row ">
                                                        <label class="control-label col-md-3 col-sm-3 ">Nama Tahap</label>
                                    ...
                                    <div class="card-box table-responsive">
                                        ...
                                        <table id="datatable" class="table table-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$no}}</td>
                                                    <td>{{$cara_kerja->tahap}}</td>
                                                    <td>{{$cara_kerja->deskripsi}}</td>
                                                    <td>
                                                        <form action="{{ route('set-carakerja.destroy', $cara_kerja->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
